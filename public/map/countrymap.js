					...
					e
						? i
							? n - 4 == i
								? (s[3] = { x: +t[0], y: +t[1] })
								: n - 2 == i &&
								  ((s[2] = { x: +t[0], y: +t[1] }), (s[3] = { x: +t[2], y: +t[3] }))
							: (s[0] = { x: +t[n - 2], y: +t[n - 1] })
						: n - 4 == i
						? (s[3] = s[2])
						: i || (s[0] = { x: +t[i], y: +t[i + 1] }),
			...
			var vt = (j.pathBBox = function (t) {
				...
				kt = ot(function (t, e, r, i, n, s, a, o) {
					...
					return (
						...
						(c = e - i),
						(f =
							(-(u = 2 * (i - e) - 2 * (s - i)) + B.sqrt(u * u - 4 * h * c)) / 2 / h),
						(p = (-u - B.sqrt(u * u - 4 * h * c)) / 2 / h),
						"1e12" < S(f) && (f = 0.5),
						"1e12" < S(p) && (p = 0.5),
						0 < f &&
											...
											function (t) {
												for (
													...
													if (t.targetTouches[i].target == s) {
														((t = t.targetTouches[i]).originalEvent =
															r),
															(t.preventDefault = Lt),
					...
					return function (t, e, r) {
						...
						return (
							...
							(o = p
								...
								: d
								? h
								: j.findDotsAtSegment(i, n, s[0], s[1], s[2], s[3], s[4], s[5], 1))
...
!(function (e) {
	...
	function f() {
		...
		if (!document.getElementById(y))
			return (
				console.log(
					"Can't find target for map #" + y + ".  Check mapdata.main_settings.div"
				),
				!1
			);
		function tA() {
		...
		function tS(e) {
			if (
				...
				v
					...
					: ((ey = void 0 === a.width ? 800 : a.width), (ed.style.width = ey + "px")),
				(ey *= 1),
				t6.calibrate
			...
			if ("lambert" == t6.proj)
				var o = function e(t) {
					var o = Math.PI,
						...
						a =
							(0.8386705593173225 * Math.pow(Math.tan(0.25 * o + 0.2879793345), r)) /
							r,
			...
			tj(),
				...
				"region" == n
					...
					: "manual" == n &&
					  eI.forEach(function (e) {
							-1 != e.sm.id &&
								(e.sm.zooming_dimensions.r > ew && e.sm.zoomable ? tV(e) : tQ(e));
					  }),
				"out" != n && "manual" != n
					? (eF.stop(),
					  eB.stop(),
		...
		function oa(e) {
			...
			for (var i in ((tr = function (e) {
				...
				n.inactive && (c.cursor = "default"),
					n.image_source &&
						((l.sm.ignore_hover = !0), (c.fill = "url(" + o + n.image_source + ")")),
			...
			(t8 = function (e) {
				...
				if (eG.hasOwnProperty(e)) {
					...
					if (
						...
						var J =
								((a.location_auto_padding ? 1 + 2 * a.location_auto_padding : 1.3) *
									_.sm.bbox.width) /
								s,
							K = _.sm.parent,
							ee = K.sm.labels,
				...
				e.sm.labels.forEach(function (e) {
					if (e.sm) {
						...
						"over" == t
							...
							: ("reset" == t || "out" == t) &&
							  (o_(e, "out"), n && (ov(n, "out", i), o && ov(n, "adjacent", i)));
					}
				});
			}
		}
			...
			o0 = function (e, t) {
				...
				if ((tz.hide(), o$(e)))
					...
					if (
						...
						return;
					e.sm.ignore_hover ||
						(o ? (e.attr(e.sm.attributes), i()) : e.animate(e.sm.attributes, D, i)),
						oy(e, "out");
				}
				function i() {
					r.isFunction(t) && t();
		...
		function o4(n) {
			...
			if (
				...
				(eu =
					void 0 === a.mobile_scaling && "no" != a.mobile_scaling ? 1 : a.mobile_scaling),
				(el = !1),
				(tT = tC(em)),
			...
			tA(),
				...
				setTimeout(function () {
					...
					of(),
						...
						(tg = function () {
							if (
								(tO(), oE(), oj(), (this.id || "set" != !this.type) && !og && !oR)
							) {
								var e,
									t = oh(this);
